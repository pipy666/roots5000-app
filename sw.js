const CACHE='roots5000-app-v0.5.2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./data/words.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./fonts/OpenDyslexic-Regular.woff'];
